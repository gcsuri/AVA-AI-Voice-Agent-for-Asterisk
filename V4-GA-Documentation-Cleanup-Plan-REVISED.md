...
✅ **V4-GA-MasterPlan.md** - remove from develop branch 
✅ **GA-CODE-CLEANUP.md** - remove from develop branch  
✅ **GA-CLEANUP-COMPLETE.md** - remove from develop branch  
...
✅ **GAv4-CHECKLIST.md** - remove from develop branch   
✅ **PRODUCTION_HARDENING_PLAN.md** - Production hardening notes  
✅ **ROADMAP_STATUS_20251025.md** - remove from develop branch   
✅ **ROADMAP_STATUS_REVIEW_OCT27.md** - remove from develop branch  
✅ **TESTING_GUIDE_P1.md** - remove from develop branch  
✅ **OPTION3_IMPLEMENTATION_ANALYSIS.md** - remove from develop branch 
...
✅ **docs/FreePBX-Integration-Guide.md** - FreePBX integration (Needs Updating) 

#### v4.0 Documentation (2 files) (Add deepgram and local hybrid pipeline baseline as well)
...
✅ **docs/EXTERNAL_MEDIA_TEST_GUIDE.md** - ExternalMedia testing guide  (Merge and keep one External Media Doc)
✅ **docs/ExternalMedia_Deployment_Guide.md** - ExternalMedia deployment  
✅ **docs/Hybrid-Pipeline-Golden-Baseline.md** - Hybrid pipeline validation  (Move to case studies)
✅ **docs/LOG_ANALYSIS_VAD_IMPLEMENTATION.md** - VAD analysis  
✅ **docs/OPENAI_FORMAT_DISCOVERY.md** - Archive 
✅ **docs/OpenAI-Realtime-Logging-Guide.md** - Archive  
✅ **docs/Updated-Voice-AI-Stack.md** - Archive 
✅ **docs/VAD_CRITICAL_FIXES_SUMMARY.md** - Archive  
✅ **docs/VAD_IMPLEMENTATION_SUMMARY.md** - Archive  
...
### docs/milestones/ Directory (4 documents - KEEP - Create similar docs for combind ROADMAP and ROADMAPv4 after merged)
